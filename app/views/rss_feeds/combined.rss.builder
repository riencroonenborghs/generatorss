...
xml.rss :version => "2.0", "xmlns:atom" => "http://www.w3.org/2005/Atom" do
  xml.channel do
    ...
    xml.description "A combined RSS feed for all your subscriptions"
    xml.link @channel.link || root_url
    xml.language "en"
    xml.lastBuildDate @channel.last_build_date
    xml.docs "https://validator.w3.org/feed/docs/rss2.html"
    xml.ttl @channel.ttl
    xml.tag! "atom:link", rel: "self", type: "application/rss+xml", href: combined_rss_feed_url(@user.uuid, format: :rss)
